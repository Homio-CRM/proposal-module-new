...
import { canManageBuildings as canManageBuildingsPermission } from '@/lib/utils/permissions'
...
export default function BuildingFormPage() {
  ...
  const allowManageBuildings = canManageBuildingsPermission(preferences ?? null, userData.role)

  if (!allowManageBuildings) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center space-y-2">
          <div className="text-yellow-500 text-xl">⚠️</div>
          <h2 className="text-lg font-semibold text-neutral-900">Sem permissão para criar empreendimentos</h2>
